    ...
    >
      <AnimatePresence initial={false}>
        ...
        >
          ...
          {showHandlebar && (
            <div className="h-6 w-6 rounded-full top-1/2 -translate-y-1/2 bg-white z-30 -right-3 absolute flex items-center justify-center border border-gray-300/80 shadow-sm">
