...
const OutfitStack: React.FC<OutfitStackProps> = ({ outfitHistory, onRemoveLastGarment }) => {
  return (
    <div className="flex flex-col">
      <h2 className="text-xl font-serif tracking-wider text-gray-800 border-b border-gray-400/50 pb-2 mb-3">Daftar Pakaian</h2>
      <div className="space-y-2">
        ...
        {outfitHistory.length === 1 && (
            <p className="text-center text-sm text-gray-500 pt-4">Pakaian yang Anda pilih akan muncul di sini. Pilih item dari lemari di bawah.</p>
        )}
      </div>
    </div>
  );
